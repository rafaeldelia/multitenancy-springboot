...
@ComponentScan(basePackages = { "com.finner.multitenant.tenant.repository",
		"com.finner.multitenant.tenant.entity" })
@EnableJpaRepositories(basePackages = { "com.finner.multitenant.tenant.repository",
		"com.finner.multitenant.tenant.service" }, entityManagerFactoryRef = "tenantEntityManagerFactory", transactionManagerRef = "tenantTransactionManager")
public class TenantDatabaseConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(
		...
		emfBean.setPackagesToScan("com.finner.multitenant");
